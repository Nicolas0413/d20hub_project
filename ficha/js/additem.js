...
const INVENTORY_KEY = window.STORAGE_KEY + "_inventario";

// ==========================
// CARREGAR ITENS
// ==========================
function loadItems() {
  const data = localStorage.getItem(window.STORAGE_KEY + "_inventario");
  if (!data) return;
...
function saveItems() {
  ...
  localStorage.setItem(window.STORAGE_KEY + "_inventario", JSON.stringify(list));
}
